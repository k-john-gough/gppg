...
// GPPG version 1.4.2
// Machine:  ATTIC-1
// DateTime: 22/07/2010 12:17:53 PM
// UserName: john
// Input file <gppg.y>
...
#pragma warning restore 649
  ...
  static Parser() {
    states[0] = new State(new int[]{138,45,140,49,141,78,142,87,143,90,144,93,146,96,147,98,149,122,148,123,151,124,150,125,156,127,152,131,155,136,153,138,157,140,154,142,158,144,159,146,126,149,137,-10},new int[]{-10,1,-12,3,-17,43,-18,148,-19,48});
    states[1] = new State(new int[]{127,2});
    states[2] = new State(-1);
    states[3] = new State(new int[]{137,42},new int[]{-13,4});
    states[4] = new State(new int[]{131,38,126,41},new int[]{-14,5,-33,40,-34,12});
    states[5] = new State(new int[]{137,8,131,38,127,-6},new int[]{-15,6,-33,7,-34,12});
    states[6] = new State(-2);
    states[7] = new State(-83);
    states[8] = new State(new int[]{128,10,127,-8},new int[]{-16,9});
    states[9] = new State(-5);
    states[10] = new State(new int[]{129,11});
    states[11] = new State(-7);
    states[12] = new State(new int[]{130,23,136,24,134,25,123,28,145,32,59,-90,124,-90},new int[]{-6,13,-7,18,-4,35,-36,26,-9,36,-8,27});
    states[13] = new State(-88,new int[]{-35,14});
    states[14] = new State(new int[]{59,15,124,16});
    states[15] = new State(-86);
    states[16] = new State(new int[]{130,23,136,24,134,25,123,28,145,32,59,-90,124,-90},new int[]{-6,17,-7,18,-4,35,-36,26,-9,36,-8,27});
    states[17] = new State(-89);
    states[18] = new State(new int[]{123,28,145,32,59,-91,124,-91},new int[]{-9,19,-8,27});
    states[19] = new State(new int[]{130,23,136,24,134,25,123,-95,145,-95,59,-95,124,-95},new int[]{-5,20,-4,21,-36,26});
    states[20] = new State(-94);
    states[21] = new State(new int[]{130,23,136,24,134,25,123,-96,145,-96,59,-96,124,-96},new int[]{-36,22});
    states[22] = new State(-98);
    states[23] = new State(-99);
    states[24] = new State(-100);
    states[25] = new State(-101);
    states[26] = new State(-97);
    states[27] = new State(-102);
    states[28] = new State(new int[]{128,10,125,-8,126,-8},new int[]{-16,29});
    states[29] = new State(new int[]{125,30,126,31});
    states[30] = new State(-105);
    states[31] = new State(-106);
    states[32] = new State(new int[]{130,33});
    states[33] = new State(new int[]{123,28,130,-104,136,-104,134,-104,145,-104,59,-104,124,-104},new int[]{-8,34});
    states[34] = new State(-103);
    states[35] = new State(new int[]{130,23,136,24,134,25,123,-92,145,-92,59,-92,124,-92},new int[]{-36,22});
    states[36] = new State(new int[]{130,23,136,24,134,25,123,-95,145,-95,59,-95,124,-95},new int[]{-5,37,-4,21,-36,26});
    states[37] = new State(-93);
    states[38] = new State(new int[]{58,39});
    states[39] = new State(-87);
    states[40] = new State(-84);
    states[41] = new State(-85);
    states[42] = new State(-4);
    states[43] = new State(new int[]{138,45,140,49,141,78,142,87,143,90,144,93,146,96,147,98,149,122,148,123,151,124,150,125,156,127,152,131,155,136,153,138,157,140,154,142,158,144,159,146,137,-9},new int[]{-18,44,-19,48});
    states[44] = new State(-12);
    states[45] = new State(new int[]{128,10,139,-8},new int[]{-16,46});
    states[46] = new State(new int[]{139,47});
    states[47] = new State(-15);
    states[48] = new State(-16);
    states[49] = new State(new int[]{60,73,130,-43,136,-43},new int[]{-20,50,-21,72});
    states[50] = new State(new int[]{130,54,136,58},new int[]{-1,51,-2,71});
    states[51] = new State(new int[]{44,60,59,61,58,62,60,63,62,64,40,65,41,66,91,67,93,68,123,69,125,70,138,-17,140,-17,141,-17,142,-17,143,-17,144,-17,146,-17,147,-17,149,-17,148,-17,151,-17,150,-17,156,-17,152,-17,155,-17,153,-17,157,-17,154,-17,158,-17,159,-17,137,-17,130,-70,136,-70},new int[]{-28,52,-29,59});
    states[52] = new State(new int[]{130,54,136,58},new int[]{-2,53});
    states[53] = new State(-47);
    states[54] = new State(new int[]{132,55,134,56,44,-51,59,-51,58,-51,60,-51,62,-51,40,-51,41,-51,91,-51,93,-51,123,-51,125,-51,130,-51,136,-51,138,-51,140,-51,141,-51,142,-51,143,-51,144,-51,146,-51,147,-51,149,-51,148,-51,151,-51,150,-51,156,-51,152,-51,155,-51,153,-51,157,-51,154,-51,158,-51,159,-51,137,-51});
    states[55] = new State(-49);
    states[56] = new State(new int[]{132,57,44,-52,59,-52,58,-52,60,-52,62,-52,40,-52,41,-52,91,-52,93,-52,123,-52,125,-52,130,-52,136,-52,138,-52,140,-52,141,-52,142,-52,143,-52,144,-52,146,-52,147,-52,149,-52,148,-52,151,-52,150,-52,156,-52,152,-52,155,-52,153,-52,157,-52,154,-52,158,-52,159,-52,137,-52});
    ...
    states[73] = new State(new int[]{130,74,126,76});
    states[74] = new State(new int[]{62,75});
    states[75] = new State(-44);
    states[76] = new State(new int[]{62,77});
    states[77] = new State(-45);
    states[78] = new State(new int[]{60,73},new int[]{-21,79});
    states[79] = new State(new int[]{130,83,131,84},new int[]{-3,80,-22,86});
    states[80] = new State(new int[]{44,60,59,61,58,62,60,63,62,64,40,65,41,66,91,67,93,68,123,69,125,70,138,-18,140,-18,141,-18,142,-18,143,-18,144,-18,146,-18,147,-18,149,-18,148,-18,151,-18,150,-18,156,-18,152,-18,155,-18,153,-18,157,-18,154,-18,158,-18,159,-18,137,-18,130,-70,131,-70},new int[]{-28,81,-29,85});
    states[81] = new State(new int[]{130,83,131,84},new int[]{-22,82});
    states[82] = new State(-55);
    states[83] = new State(-57);
    states[84] = new State(-58);
    states[85] = new State(-56);
    states[86] = new State(-54);
    states[87] = new State(new int[]{60,73,130,-43,136,-43},new int[]{-20,88,-21,72});
    states[88] = new State(new int[]{130,54,136,58},new int[]{-1,89,-2,71});
    states[89] = new State(new int[]{44,60,59,61,58,62,60,63,62,64,40,65,41,66,91,67,93,68,123,69,125,70,138,-19,140,-19,141,-19,142,-19,143,-19,144,-19,146,-19,147,-19,149,-19,148,-19,151,-19,150,-19,156,-19,152,-19,155,-19,153,-19,157,-19,154,-19,158,-19,159,-19,137,-19,130,-70,136,-70},new int[]{-28,52,-29,59});
    states[90] = new State(new int[]{60,73,130,-43,136,-43},new int[]{-20,91,-21,72});
    states[91] = new State(new int[]{130,54,136,58},new int[]{-1,92,-2,71});
    states[92] = new State(new int[]{44,60,59,61,58,62,60,63,62,64,40,65,41,66,91,67,93,68,123,69,125,70,138,-20,140,-20,141,-20,142,-20,143,-20,144,-20,146,-20,147,-20,149,-20,148,-20,151,-20,150,-20,156,-20,152,-20,155,-20,153,-20,157,-20,154,-20,158,-20,159,-20,137,-20,130,-70,136,-70},new int[]{-28,52,-29,59});
    states[93] = new State(new int[]{60,73,130,-43,136,-43},new int[]{-20,94,-21,72});
    states[94] = new State(new int[]{130,54,136,58},new int[]{-1,95,-2,71});
    states[95] = new State(new int[]{44,60,59,61,58,62,60,63,62,64,40,65,41,66,91,67,93,68,123,69,125,70,138,-21,140,-21,141,-21,142,-21,143,-21,144,-21,146,-21,147,-21,149,-21,148,-21,151,-21,150,-21,156,-21,152,-21,155,-21,153,-21,157,-21,154,-21,158,-21,159,-21,137,-21,130,-70,136,-70},new int[]{-28,52,-29,59});
    states[96] = new State(new int[]{130,83,131,84},new int[]{-22,97});
    states[97] = new State(-22);
    states[98] = new State(new int[]{130,121,123,-39},new int[]{-23,99});
    states[99] = new State(new int[]{123,101},new int[]{-24,100});
    states[100] = new State(-23);
    states[101] = new State(new int[]{130,117,126,120},new int[]{-30,102,-31,119,-32,105,-27,118,-25,109});
    states[102] = new State(new int[]{125,103,130,117},new int[]{-31,104,-32,105,-27,118,-25,109});
    states[103] = new State(-62);
    states[104] = new State(-64);
    states[105] = new State(new int[]{130,106},new int[]{-27,108,-25,109});
    states[106] = new State(new int[]{59,107,91,-41,46,-41,60,-41,130,-41});
    states[107] = new State(-66);
    states[108] = new State(-68);
    states[109] = new State(new int[]{91,110,46,112,60,114,130,-61,62,-61,138,-61,140,-61,141,-61,142,-61,143,-61,144,-61,146,-61,147,-61,149,-61,148,-61,151,-61,150,-61,156,-61,152,-61,155,-61,153,-61,157,-61,154,-61,158,-61,159,-61,137,-61});
    states[110] = new State(new int[]{93,111});
    states[111] = new State(-59);
    states[112] = new State(new int[]{130,113});
    states[113] = new State(-40);
    states[114] = new State(new int[]{130,117},new int[]{-27,115,-25,109});
    states[115] = new State(new int[]{62,116});
    ...
    states[125] = new State(new int[]{130,117},new int[]{-25,126});
    states[126] = new State(new int[]{46,112,138,-27,140,-27,141,-27,142,-27,143,-27,144,-27,146,-27,147,-27,149,-27,148,-27,151,-27,150,-27,156,-27,152,-27,155,-27,153,-27,157,-27,154,-27,158,-27,159,-27,137,-27});
    states[127] = new State(new int[]{130,117},new int[]{-25,128});
    states[128] = new State(new int[]{46,112,59,130,138,-72,140,-72,141,-72,142,-72,143,-72,144,-72,146,-72,147,-72,149,-72,148,-72,151,-72,150,-72,156,-72,152,-72,155,-72,153,-72,157,-72,154,-72,158,-72,159,-72,137,-72},new int[]{-26,129});
    states[129] = new State(-28);
    states[130] = new State(-71);
    states[131] = new State(new int[]{61,132});
    states[132] = new State(new int[]{133,133,134,134,135,135});
    states[133] = new State(-29);
    states[134] = new State(-30);
    states[135] = new State(-31);
    states[136] = new State(new int[]{130,137});
    states[137] = new State(-32);
    states[138] = new State(new int[]{130,139});
    states[139] = new State(-33);
    states[140] = new State(new int[]{130,141});
    states[141] = new State(-34);
    states[142] = new State(new int[]{130,143});
    states[143] = new State(-35);
    states[144] = new State(new int[]{130,117},new int[]{-27,145,-25,109});
    states[145] = new State(-36);
    states[146] = new State(new int[]{130,117},new int[]{-27,147,-25,109});
